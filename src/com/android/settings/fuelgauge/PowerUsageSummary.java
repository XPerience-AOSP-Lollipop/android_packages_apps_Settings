...
public class PowerUsageSummary extends PowerUsageBase {
    ...
    private static final int SUBMENU_BATTERY_LANDSCAPE      = Menu.FIRST + 8;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        int selectedIcon = CMSettings.System.getInt(getActivity().getContentResolver(),
                                    CMSettings.System.STATUS_BAR_BATTERY_STYLE, 0);
        int selectedPercentage = CMSettings.System.getInt(getActivity().getContentResolver(),
        ...
        batteryStyle.add(1, SUBMENU_BATTERY_LANDSCAPE, 2, R.string.status_bar_battery_style_icon_landscape)
                    .setChecked(selectedIcon == 5);
        batteryStyle.add(1, SUBMENU_BATTERY_CIRCLE, 3, R.string.status_bar_battery_style_circle)
                    .setChecked(selectedIcon == 2);
        batteryStyle.add(1, SUBMENU_BATTERY_TEXT, 4, R.string.status_bar_battery_style_text)
        ...
        batteryPercentMenu.add(1, SUBMENU_BATTERY_PERCENT_HIDDEN, 1, R.string.status_bar_battery_percentage_default)
                    .setChecked(selectedPercentage == 0);
        batteryPercentMenu.add(1, SUBMENU_BATTERY_PERCENT_INSIDE, 2, R.string.status_bar_battery_percentage_text_inside)
                    .setChecked(selectedPercentage == 1);
        batteryPercentMenu.add(1, SUBMENU_BATTERY_PERCENT_NEXT, 3, R.string.status_bar_battery_percentage_text_next)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
	        ...
	        case SUBMENU_BATTERY_LANDSCAPE:
                item.setChecked(true);
                CMSettings.System.putInt(getActivity().getContentResolver(),
                    CMSettings.System.STATUS_BAR_BATTERY_STYLE, 5);
                return true;
            case SUBMENU_BATTERY_CIRCLE:
                item.setChecked(true);
                CMSettings.System.putInt(getActivity().getContentResolver(),
                    CMSettings.System.STATUS_BAR_BATTERY_STYLE, 2);
                return true;
            case SUBMENU_BATTERY_TEXT:
                item.setChecked(true);
                CMSettings.System.putInt(getActivity().getContentResolver(),
                    CMSettings.System.STATUS_BAR_BATTERY_STYLE, 6);
                return true;
            case SUBMENU_BATTERY_HIDDEN:
                item.setChecked(true);
                CMSettings.System.putInt(getActivity().getContentResolver(),
                    CMSettings.System.STATUS_BAR_BATTERY_STYLE, 4);
                return true;
            ...
            case SUBMENU_BATTERY_PERCENT_INSIDE:
                item.setChecked(true);
                CMSettings.System.putInt(getActivity().getContentResolver(),
                    CMSettings.System.STATUS_BAR_SHOW_BATTERY_PERCENT, 1);
                return true;
            case SUBMENU_BATTERY_PERCENT_NEXT:
                item.setChecked(true);
                CMSettings.System.putInt(getActivity().getContentResolver(),
                    CMSettings.System.STATUS_BAR_SHOW_BATTERY_PERCENT, 2);
                return true;
